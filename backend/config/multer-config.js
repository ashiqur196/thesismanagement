...
const storage = multer.diskStorage({
  destination: (req, file, cb) => {
    ...
    if (file.fieldname === 'image') uploadPath = path.join(uploadPath, 'profiles');
    if (file.fieldname === 'document') uploadPath = path.join(uploadPath, 'documents');
    if (file.fieldname === 'gallery') uploadPath = path.join(uploadPath, 'gallery');
